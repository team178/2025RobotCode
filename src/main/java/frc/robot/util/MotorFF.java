...
// Edited by Team 178 for adjustable constants(also remove to be depreciated method), based on edu.wpi.first.math.controller.ArmFeedforward
 ...
 */
public class MotorFF implements ProtobufSerializable, StructSerializable {
     ...
     */
    public MotorFF(double ks, double kg, double kv, double ka, double dtSeconds) {
        this.ks = ks;
        this.kg = kg;
        this.kv = kv;
        this.ka = ka;
